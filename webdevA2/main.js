...
const techniques = [
    ...
    {
        h2: "Dribbling",
        p: "Dribbling allows players to advance the ball, evade defenders, and create space for themselves or their teammates. It is carried out by taking small, controlled touches with the inside and outside of the foot while keeping the ball close. Players stay balanced, change direction quickly, and keep their heads up to scan the field.",
